...
const AdminSubscriptionManagement = () => {
  ...
  const fetchSubscriptions = async () => {
    try {
      ...
      let url = `/api/admin/subscriptions/all?page=${subscriptionPagination.page}&limit=${subscriptionPagination.limit}`;
  ...
  const fetchUsers = async () => {
    try {
      ...
      let url = `/api/admin/subscriptions/users?page=${userPagination.page}&limit=${userPagination.limit}`;
  ...
  const handleApproveSubscription = async () => {
    try {
      const token = localStorage.getItem('authToken');
      await Axios.put(
        `/api/admin/subscriptions/${selectedSubscription._id}/approve`,
        {},
        { headers: { Authorization: `Bearer ${token}` } }
      );
  ...
  const handleRejectSubscription = async () => {
    try {
      const token = localStorage.getItem('authToken');
      await Axios.put(
        `/api/admin/subscriptions/${selectedSubscription._id}/reject`,

  ...
  const handleGoogleSignIn = () => {
    try {
      ...
      if (redirectFrom === '/login') {
        window.location.href = `https://www.mcquiz.online/api/auth/google?from=${encodeURIComponent('/')}`;
      } else {
        window.location.href = `https://www.mcquiz.online/api/auth/google?from=${encodeURIComponent(redirectFrom)}`;
      }
    } catch (error) {
